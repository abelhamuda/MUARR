...
@section('title', 'Magic Cube')

@section('content')
    <h1 class="text-3xl font-bold mb-1">Magic Cube Process</h1>

    {{-- Clickable Sensor Information --}}
    <h2 id="magic-cube-info" class="font-regular mb-5 cursor-pointer text-blue-600 hover:underline">
    ...
    <form action="{{ route('magic') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
    ...
    <script>
        document.getElementById('magic-cube-info').addEventListener('click', function () {
            alert('The Landsat');
        });
