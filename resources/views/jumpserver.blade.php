...
@section('title', 'Jumpserver')

@section('content')
    <h1 class="text-3xl font-bold mb-1">Jumpserver Process</h1>

    {{-- Clickable SSO Information --}}
    <h2 id="gitlab-info" class="font-regular mb-5 cursor-pointer text-blue-600 hover:underline">
        Jumpserver Application Information
    </h2>
    ...
    <form action="{{ route('jumpserver') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
