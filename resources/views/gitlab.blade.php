...
@section('content')
    <h1 class="text-3xl font-bold mb-1">Gitlab Process</h1>
    ...
    <form action="{{ route('gitlab') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
