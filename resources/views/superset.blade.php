...
@section('content')
    ...
    <div id="modal" style="display: none;" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
        <div class="bg-white w-1/3 p-5 rounded-lg shadow-lg">
            <h3 class="text-xl font-bold mb-4">Superset Application Information</h3>
            <p>The Superset Application includes:</p>
    ...
    <form action="{{ route('superset') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
